using HumphreyJ.NetCore.Devices.GPIO;
using System;
using System.Device.Gpio;
using System.Linq;

namespace MatrixKeyboardTest
{
    class Program
    {
        ...
        private static void Mk_PinChangeEvent(object sender, MatrixButtonEventArgs pinValueChangedEventArgs)
        {
            //  清空屏幕
            Console.Clear();

            //  输出事件
            Console.WriteLine($"{DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss.ffffff")} {pinValueChangedEventArgs.Row}, {pinValueChangedEventArgs.Column}, {pinValueChangedEventArgs.EventType}");
            Console.WriteLine();
