...
namespace HumphreyJ.NetCore.Devices.GPIO
{
    /// <summary>
    /// GPIO 矩阵键盘驱动
    /// </summary>
    public class MatrixKeyboard : IDisposable
    {
        ...
        public delegate void PinChangeEventHandler(object sender, MatrixButtonEventArgs pinValueChangedEventArgs);
        ...
        private void ScanTimerElapsed(object sender, ElapsedEventArgs e)
        {
            for (var i = 0; i < colPins.Length; i++)
            {
                ...
                {
                    var args = new MatrixButtonEventArgs(newValue == PinValue.High ? PinEventTypes.Rising : PinEventTypes.Falling, currentRow, i);
    ...
    /// 按钮事件
    /// </summary>
    public class MatrixButtonEventArgs : EventArgs
    {
        /// <summary>
        ...
        internal MatrixButtonEventArgs(PinEventTypes eventType, int row, int column)
        {
            EventType = eventType;
            Row = row;
            Column = column;
